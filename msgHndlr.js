...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = '6282113695382@c.us'
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/adisubagja', donate)
            break
        case '!tts':
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6282113695382@c.us')
            break
        case '!ig':
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, 'https://github.com/adisubagja/WA-NetzBot', info)
            break
        case '!snk':
